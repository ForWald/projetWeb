...
class ProgrammeController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('pages/programme/new.html.twig', [
            'programme' => $programme,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('pages/programme/show.html.twig', [
            'programme' => $programme,
        ]);
    }
    ...
    public function edit(Request $request, Programme $programme, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('pages/programme/edit.html.twig', [
            'programme' => $programme,
            'form' => $form,
        ]);
    }
